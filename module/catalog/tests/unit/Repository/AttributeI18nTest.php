...
class AttributeI18nTest extends \WellCart\Test\TestCase
{
    ...
    /**
     * @todo   Implement testCreateAttributeEntity().
     */
    public function testCreateAttributeEntity()
    {
        // Remove the following lines when you implement this test.
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
    ...
    /**
     * @todo   Implement testFindAllAttributeIds().
     */
    public function testFindAllAttributeIds()
    {
        // Remove the following lines when you implement this test.
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
