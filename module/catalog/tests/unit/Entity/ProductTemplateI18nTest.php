...
class ProductTemplateI18nTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @todo   Implement testGetProductTemplateId().
     */
    public function testGetProductTemplateId()
    {
        // Remove the following lines when you implement this test.
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
    ...
    /**
     * @todo   Implement testSetProductTemplateId().
     */
    public function testSetProductTemplateId()
    {
        // Remove the following lines when you implement this test.
        $this->markTestIncomplete(
            'This test has not been implemented yet.'
