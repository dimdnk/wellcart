 ...
 */
namespace WellCart\Theme\FrontendUi\Test\Traits;
...
trait UnitTesterActions
{
     ...
     */
    public function assertGreaterOrEquals($expected, $actual,
        $description = null
    ) {
        return $this->getScenario()->runStep(
            new \Codeception\Step\Action(
    ...
    {
        return $this->getScenario()->runStep(
            new \Codeception\Step\Action('assertNotInstanceOf', func_get_args())
        );
    }
