...
return [
    'blocks' => [
         ...
         * WellCart\Ui\Layout\Layout\Layout::getBlock('my.unique.block.id');
         */
        'my.unique.block.id' => [
            /**
             * Can extend from WellCart\Ui\Layout\Block\AbstractBlock
             * Should implement WellCart\Ui\Layout\Block\BlockInterface
...
// - __call() methods are implemented by a proxy (WellCart\Ui\Layout\View\Helper\Proxy)
// Examples:
