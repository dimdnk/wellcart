...
namespace WellCart\Money\Form\Element;

use Zend\Form\Element\Select;
use WellCart\Money\Money\Currency;
use Zend\InputFilter\InputProviderInterface;
use Zend\Validator\ValidatorInterface;
use WellCart\Money\Validator\CurrencyCode as CurrencyValidator;
...
class SelectCurrency extends Select implements InputProviderInterface
{
    ...
    public function makeCurrency($code)
    {
        if (is_string($code)) {
            ...
            } catch (\WellCart\Money\Exception\ExceptionInterface $e) {
