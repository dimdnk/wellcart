...
return [
    'object_mapping' => [
        'WellCart\Admin\Entity\Administrator' =>
            [
                'type' => 'entity',
                'repositoryClass' => 'WellCart\Admin\Repository\Administrators',
                'table' => 'admin_users',
                'entityListeners' => [
                    'WellCart\Admin\EventListener\AdministratorEntityListener' => [
        ...
        'WellCart\Admin\Entity\Notification' =>
            [
                ...
                'entityListeners' => [
                    'WellCart\Admin\EventListener\NotificationEntityListener' => [
                        'preRemove' => ['preRemove' => 'preRemove'],
                    ],
                ],
                'gedmo' => [
        ...
        'WellCart\User\Entity\Acl\Role' =>
            [
                'type' => 'entity',
                'entityListeners' => [
                    'WellCart\Admin\EventListener\RoleEntityListener' => [
                        'preUpdate' => ['preUpdate' => 'preUpdate'],
                        'preRemove' => ['preRemove' => 'preRemove'],
                    ],
                ],
