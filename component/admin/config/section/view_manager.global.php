 ...
 */
return [
    'wellcart-admin/page-view/grid/standard/layout'         => __DIR__
        . '/../../view/page-view/grid/standard/layout.phtml',
    'wellcart-admin/page-view/grid/standard/table'          => __DIR__
        . '/../../view/page-view/grid/standard/table.phtml',
    'wellcart-admin/page-view/grid/standard/header-toolbar' => __DIR__
        . '/../../view/page-view/grid/standard/header-toolbar.phtml',
    'wellcart-admin/page-view/grid/standard/footer-toolbar' => __DIR__
        . '/../../view/page-view/grid/standard/footer-toolbar.phtml',
    'wellcart-admin/page-view/form/standard/layout'         => __DIR__
        . '/../../view/page-view/form/standard/layout.phtml',
    'wellcart-admin/page-view/form/standard/toolbar'        => __DIR__
        . '/../../view/page-view/form/standard/toolbar.phtml',
    'wellcart-admin/login/form'                             => __DIR__
        . '/../../view/template/login/form.phtml',
    'wellcart-admin/recover-account/initiate'               => __DIR__
        . '/../../view/template/recover-account/initiate.phtml',
    'wellcart-admin/recover-account/reset'                  => __DIR__
        . '/../../view/template/recover-account/reset.phtml',
    'wellcart-admin/item-view/page-navigator'               => __DIR__
        . '/../../view/item-view/page-navigator.phtml',
    'wellcart-admin/partial/settings/navigation'            => __DIR__
        . '/../../view/partial/settings/navigation.phtml',
    'wellcart-admin/dashboard/index'                        => __DIR__
        . '/../../view/template/dashboard/index.phtml',
    'wellcart-admin/settings/update'                        => __DIR__
        . '/../../view/template/settings/update.phtml',
    'wellcart-admin/item-view/main-navigation-menu'         => __DIR__
        . '/../../view/item-view/main-navigation-menu.phtml',
    'wellcart-admin/item-view/account/welcome-box'          => __DIR__
        . '/../../view/item-view/account/welcome-box.phtml',
    'wellcart-admin/item-view/top-branding'                 => __DIR__
