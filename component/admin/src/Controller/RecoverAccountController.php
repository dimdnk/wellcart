...
use WellCart\Admin\Service\RecoverAccount as RecoverAccountService;
    ...
    public function initiateAction()
    {
        ...
        return
            $this->createPageView()
                ...
                ->setTemplate('wellcart-admin/recover-account/initiate');
    }
    ...
    public function resetAction()
    {
        ...
        return
            $this->createPageView()
                ...
                ->setTemplate('wellcart-admin/recover-account/reset');
    }
