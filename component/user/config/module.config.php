...
return [
    ...
    'service_manager'       => [
        ...
        'invokables'         => [
            'zfcuser_user_service'                                                => 'WellCart\User\Service\User',
            ...
            'WellCart\User\EventListener\Login\EmailNotConfirmed'                 => 'WellCart\User\EventListener\Login\EmailNotConfirmed',
            'WellCart\User\EventListener\Login\HandleFailedLoginCount'            => 'WellCart\User\EventListener\Login\HandleFailedLoginCount',
            'WellCart\User\EventListener\Login\IdentityReview'                    => 'WellCart\User\EventListener\Login\IdentityReview',
            ...
            'WellCart\User\EventListener\Registration\SetDefaultAccountSettings'  => 'WellCart\User\EventListener\Registration\SetDefaultAccountSettings',
            'WellCart\User\EventListener\UnauthorizedStrategy'                    => 'WellCart\User\EventListener\UnauthorizedStrategy',
            'WellCart\User\Command\Handler\PersistUserAccountHandler'             => 'WellCart\User\Command\Handler\PersistUserAccountHandler',
        ],
        'factories'          => [],
        'abstract_factories' => [],
        'services'           => [],
